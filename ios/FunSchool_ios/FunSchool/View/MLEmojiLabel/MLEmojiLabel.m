...
//REGULAREXPRESSION(PhoneNumerRegularExpression, @"(\\d{3}\\-\\d{8})|(\\d{3}\\-\\d{7})|(\\d{4}\\-\\d{8})|(\\d{4}\\-\\d{7})|(1+[358]+\\d{9})|(\\d{8})|(\\d{7})|(\\d{3}\\-\\d{4}-\\d{3})")
REGULAREXPRESSION(PhoneNumerRegularExpression, @"(\\d{3}\\-\\d{8})|(\\d{3}\\-\\d{7})|(\\d{4}\\-\\d{8})|(\\d{4}\\-\\d{7})|(1+[358]+\\d{9})|(\\d{8})|(\\d{7})|(\\d{2,8}\\-?\\d{3,8}-?\\d{0,8})")

REGULAREXPRESSION(TELPhoneNumerRegularExpression,@"(\\d{11})|^((\\d{7,8})|(\\d{4}|\\d{3})-(\\d{7,8})|(\\d{4}|\\d{3})\\-(\\d{7,8})\\-(\\d{4}|\\d{3}|\\d{2}|\\d{1})|(\\d{7,8})\\-(\\d{4}|\\d{3}|\\d{2}|\\d{1}))$")
...
- (void)setText:(id)text
{
    ...
    NSRegularExpression * const regexps[] = {kURLRegularExpression(),kEmailRegularExpression(),kPhoneNumerRegularExpression(),kAtRegularExpression(),kPoundSignRegularExpression(),kTELPhoneNumerRegularExpression()};
